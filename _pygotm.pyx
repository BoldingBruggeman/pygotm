...
cdef extern void calculate_3d(int nx, int ny, int nz, int istart, int istop, int jstart, int jstop, double dt, const int* mask, const double* h3d, const double* D, const double* u_taus, const double* u_taub, const double* z0s, const double* z0b, const double* NN, const double* SS, double* tke, double* eps, double* L, double* num, double* nuh)
